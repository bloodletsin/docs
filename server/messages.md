> For the complete documentation index, see [llms.txt](https://docs.evelina.bot/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.evelina.bot/server/messages.md).
...
```
GET https://docs.evelina.bot/server/messages.md?ask=<question>&goal=<endgoal>
```
